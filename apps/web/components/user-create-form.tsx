...
export function UserCreateForm() {
  ...
  return (
    <>
      ...
      {credentials && (
        <div role="status">
          <p>Share these credentials privately. This temporary password is shown only now.</p>
          <p>
          ...
          <p>A password change is required at first login.</p>
          <Button variant="secondary" type="button" onPress={() => setCredentials(null)}>
            Dismiss credentials
          </Button>
        </div>
      )}
