...
export function ApiAccess({ keys, models, baseUrl }: { keys: KeyView[]; models: string[]; baseUrl: string }) {
  ...
  return <>
    <Card className="connection-card"><h2>Connect your client</h2>
